...
const circles = [
  {
    ...
    members: [
      { name: "You", initials: "Y", contributed: true, amount: "£40", colors: "from-[#4e596d] to-[#212a3c]" },
      { name: "Maya", initials: "M", contributed: true, amount: "£35", colors: "from-[#efc3af] to-[#ae6e57]" },
      { name: "James", initials: "J", contributed: false, amount: "—", colors: "from-[#4e596d] to-[#212a3c]" },
      { name: "Fiona", initials: "F", contributed: true, amount: "£20", colors: "from-[#809168] to-[#41512e]" },
    ],
    pot: {
      active: true,
  ...
  },
  {
    ...
    description: "A family circle for one stronger shared gift rather than several smaller separate ones.",
    members: [
      { name: "You", initials: "Y", contributed: true, amount: "£50", colors: "from-[#4e596d] to-[#212a3c]" },
      { name: "Mum", initials: "M", contributed: false, amount: "—", colors: "from-[#eac8b8] to-[#9d6957]" },
      { name: "Sarah", initials: "S", contributed: false, amount: "—", colors: "from-[#e8b9a7] to-[#bf755f]" },
    ],
    pot: {
      active: true,
  ...
  {
    id: 3,
    name: "James Promotion",
    subtitle: "Milestone · July 16",
    description: "A smaller shared circle for celebrating James’s promotion with something useful and lasting.",
    members: [
      { name: "You", initials: "Y", contributed: false, amount: "—", colors: "from-[#4e596d] to-[#212a3c]" },
      { name: "Maya", initials: "M", contributed: false, amount: "—", colors: "from-[#efc3af] to-[#ae6e57]" },
    ],
    pot: {
      active: false,
      item: "",
      ...
      target: 0,
      raised: 0,
      note: "Choose one of James’s hints to turn this into a communal pot.",
    },
  },
];
...
function ContactCard({ contact }) {
  return (
    <article
      draggable
      className="cursor-grab rounded-[22px] border border-[#f0dfd6] bg-white p-4 shadow-sm active:cursor-grabbing"
    ...
    >
      <div className="flex items-center gap-3">
        ...
        <div className="min-w-0">
          ...
          <p className="text-xs text-slate-500">{contact.role} · {contact.note}</p>
        </div>
      </div>
    </article>
  );
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="mt-1 flex items-center gap-2">
            ...
            <span className="text-[11px] text-slate-400">{member.amount}</span>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div>
      ...
      <div className="mt-3 h-3 overflow-hidden rounded-full bg-[#f3e7df]">
        <div
          className="h-full rounded-full bg-gradient-to-r from-[#ff9b75] to-[#f36f64]"
          ...
          {circle.pot.active ? (
            <>
              ...
              <div className="mt-5 rounded-[22px] bg-[#2f3b2d] p-4 text-white">
                ...
                <p className="mt-2 text-sm leading-7 text-white/90">
                  Members who have not contributed yet remain marked as pending so the organiser can quickly see who still needs a nudge.
                </p>
              </div>
            </>
          ) : (
            <div className="mt-5 rounded-[22px] border border-dashed border-[#e5d8cf] bg-white p-5">
              ...
              <p className="mt-2 text-[14px] leading-7 text-slate-600">
                Pick one of this contact’s saved hints and turn it into a communal funding goal for the whole circle.
              </p>
                ...
                <div className="mb-5 flex flex-wrap items-end justify-between gap-4">
                  <div>
                    ...
                    <p className="mt-3 max-w-[760px] text-[15px] leading-7 text-slate-600">
                      Add members, choose a saved hint from the person the circle is for, and turn it into a communal pot everyone can work toward together.
                    </p>
                  </div>
